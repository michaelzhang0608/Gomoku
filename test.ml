...
let saved_table = save_game reseted
...
let load_players_test name player1 player2 expected_output = 
  name >:: (fun _ -> assert_equal expected_output 
               (load_players "board.csv"))

let save_game_test name board expected_output = 
  name >:: (fun _ -> assert_equal expected_output ((save_game board)))
...
let board_tests = [
  ...
  (* check_victor_test "4 in a col" col_4 8 5 false; *)
  check_victor_test "5 in a col" col_5 8 5 true;
  check_victor_test "not 5 in a col" not_col_5 10 10 false;
  check_victor_test "5 in northwest diagonal" nw_5 5 5 true;
  (* check_victor_test "not 5 in northwest diagonal" not_nw_5 6 10 false; *)
